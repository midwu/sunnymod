...
public class ModMenuIntegration implements ModMenuApi {
    ...
    private Screen buildConfigScreen(Screen parent) {
        ...
        features.addEntry(eb.startBooleanToggle(
                ...
                .setDefaultValue(true)
                .setTooltip(Text.literal("Enable/disable fishing contest logging. The fishing timer always works."))
        ...
        feedback.addEntry(eb.startBooleanToggle(
                        ...
                        cfg.feedbackShopAdded)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show message when a new shop is added to the CSV"))
                .setSaveConsumer(v -> cfg.feedbackShopAdded = v)
                .build());

        feedback.addEntry(eb.startBooleanToggle(
                        Text.literal("Shop: Updated"),
                        cfg.feedbackShopUpdated)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show message when an existing shop entry is updated"))
                .setSaveConsumer(v -> cfg.feedbackShopUpdated = v)
                .build());

        feedback.addEntry(eb.startBooleanToggle(
                        Text.literal("Shop: Not Looking at Sign"),
                        cfg.feedbackShopNotSign)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show warning when a shop message fires but you are not looking at an oak wall sign"))
                .setSaveConsumer(v -> cfg.feedbackShopNotSign = v)
                .build());

        feedback.addEntry(eb.startBooleanToggle(
                        Text.literal("Shop: Save Failed"),
                        cfg.feedbackShopSaveFailed)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show error when shop data fails to save to CSV"))
                .setSaveConsumer(v -> cfg.feedbackShopSaveFailed = v)
                .build());

        feedback.addEntry(eb.startBooleanToggle(
                        Text.literal("Shop: Warp Set"),
                        cfg.feedbackWarpSet)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show message when the current warp is updated via /sunnymod shoplogger setwarp"))
        ...
        feedback.addEntry(eb.startBooleanToggle(
                        ...
                        cfg.feedbackEarningsPerSale)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show message on every sale (can be noisy if selling many items)"))
        ...
        feedback.addEntry(eb.startBooleanToggle(
                        ...
                        cfg.feedbackFishingExported)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show message when fishing contest data is saved to CSV"))
                .setSaveConsumer(v -> cfg.feedbackFishingExported = v)
                .build());

        feedback.addEntry(eb.startBooleanToggle(
                        Text.literal("Fishing: Export Failed"),
                        cfg.feedbackFishingFailed)
                .setDefaultValue(true)
        ...
        feedback.addEntry(eb.startBooleanToggle(
                        ...
                        cfg.feedbackEarningsReset)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show confirmation when /sunnymod earnings reset is run"))
                .setSaveConsumer(v -> cfg.feedbackEarningsReset = v)
                .build());

        feedback.addEntry(eb.startBooleanToggle(
                        Text.literal("Command: Fishing Offset"),
                        cfg.feedbackFishingOffset)
                .setDefaultValue(true)
                .setTooltip(Text.literal("Show confirmation when /sunnymod fishing adjusttime is run"))
                .setSaveConsumer(v -> cfg.feedbackFishingOffset = v)
                .build());
        ...
        hud.addEntry(eb.startIntSlider(
                ...
                .setSaveConsumer(v -> cfg.earningsHideDelayMinutes = v)
                .build());
        ...
        hud.addEntry(eb.startIntSlider(
                ...
                .setDefaultValue(5)
                .setTooltip(Text.literal("Hide the shop panel after this many minutes of no shop activity"))
                .setSaveConsumer(v -> cfg.shopHideDelayMinutes = v)
                .build());

        hud.addEntry(eb.startBooleanToggle(
                        Text.literal("Fishing Panel Visible"),
                        cfg.fishingVisible)
                .setDefaultValue(true)
                .setSaveConsumer(v -> cfg.fishingVisible = v)
                .build());

        hud.addEntry(eb.startBooleanToggle(
                        Text.literal("Earnings Panel Visible"),
                        cfg.earningsVisible)
                .setDefaultValue(true)
                .setSaveConsumer(v -> cfg.earningsVisible = v)
                .build());

        hud.addEntry(eb.startBooleanToggle(
                        Text.literal("Shop Panel Visible"),
                        cfg.shopVisible)
                .setDefaultValue(true)
        ...
        hud.addEntry(eb.startBooleanToggle(
                        Text.literal("Reset HUD to Defaults (toggle to confirm)"),
                        false)
                .setDefaultValue(false)
                .setTooltip(Text.literal("Toggle ON and save to reset all panel positions and visibility to defaults"))
        ...
        resets.addEntry(eb.startTextDescription(
                        Text.literal("§cThese actions take effect immediately when you save."))
                .build());

        resets.addEntry(eb.startBooleanToggle(
                        Text.literal("Reset Earnings (toggle to confirm)"),
                        false)
                .setDefaultValue(false)
                .setTooltip(Text.literal("Toggle ON and save to reset all earnings data to $0.00"))
                .setSaveConsumer(v -> { if (v) EarningsDetector.reset(); })
                .build());
